    ...
    >
      <div className="grid gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8">
          <Reveal
            as="h2"
            className="max-w-4xl font-serif text-[clamp(2.6rem,6vw,6.4rem)] leading-[.9] tracking-[-.05em] sm:leading-[.84] sm:tracking-[-.06em]"
          >
      ...
      <Reveal
        as="figure"
        className="relative mt-16 aspect-[16/9] overflow-hidden sm:mt-24 lg:mx-24"
      >
        <img
          src={architectureImage}
          alt="Fachada de arquitetura contemporânea, referência do padrão de projeto do curso"
          loading="lazy"
          className="absolute inset-0 h-full w-full object-cover sepia-[.12]"
        />
        <div
          aria-hidden="true"
